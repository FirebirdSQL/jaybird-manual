...
since:[Jaybird 5.0.8/6.0.2] +
since:[Firebird 5.0.3]
...
`jdk.net.useFastTcpLoopback`:: since:[Firebird 3.0.2] until:[Firebird 5.0] since:[Jave 8 update 60] since:[Windows 8 / Windows Server 2012]
