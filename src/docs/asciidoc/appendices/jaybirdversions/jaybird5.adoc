...
[NOTE]
====
Although Jaybird 5 is still supported, we recommend upgrading to <<jb6,Jaybird 6>> if you target Java 17 or higher and Firebird 3.0 and higher.
====
...
<<jb6,Jaybird 6>> uses Java 17 as the baseline (minimum) version.
We highly recommend upgrading to Java 17 or higher and to Jaybird 6.

Jaybird 5 serves as a "`long-term support`" version for Java 8 and 11, with maintenance releases at least until the release of Jaybird 7.
...
Support for ChaCha64 was added in <<jb6,Jaybird 6>>.
...
[[jb5-distribution-gradle]]
===== Gradle

See also <<jb5-distribution-maven>>.
...
----
implementation 'org.firebirdsql.jdbc:jaybird:{jaybird5-example-version}'
----

.JNA dependency for native and embedded
[source,groovy,subs="verbatim,attributes"]
----
implementation 'net.java.dev.jna:jna:{jaybird5-jna-version}'
----
