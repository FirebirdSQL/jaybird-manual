...
|Optional dependency, required for ChaCha64 support (with `chacha64-plugin`)

|`jaybird-native-{jaybird6-full-version}.jar`
|Optional dependency, support for native and embedded connections.
...
[[jb6-distribution-gradle]]
===== Gradle

See also <<jb6-distribution-maven>>.
...
----
implementation 'org.firebirdsql.jdbc:jaybird:{jaybird6-full-version}'
----

.Jaybird native artifact (native and embedded protocol)
[source,groovy,subs="verbatim,attributes"]
----
implementation 'org.firebirdsql.jdbc:jaybird-native:{jaybird6-full-version}'
----

.ChaCha64 wire encryption plugin
[source,groovy,subs="verbatim,attributes"]
----
implementation 'org.firebirdsql.jdbc:chacha64-plugin:{jaybird6-full-version}'
----
