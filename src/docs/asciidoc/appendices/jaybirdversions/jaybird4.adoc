...
Jaybird 4 supports the protocol improvements of Firebird 4 like statement and session timeouts.
It does not implement the new batch protocol.

Jaybird time zone support uses functionality added after Firebird 4 beta 1 (4.0.0.1436).
You will need Firebird version 4.0.0.1683 or later for the `dataTypeBind` connection property.
