...
See the Firebird 4.0 release notes and `doc/sql.extensions/README.time_zone.md` in the Firebird installation for details on these types.
...
1.  specifies the Firebird 4.0 session time zone ([.since]_Jaybird 3.0.6_),
