...
* until:[Jaybird 5] The JCA layer represents the heart of the driver.
...
* since:[Jaybird 5] The XCA layer is a replacement of the JCA layer of previous versions.
...
For the JDBC specification, see https://jcp.org/en/jsr/detail?id=221[JSR 221: JDBC^TM^ 4.0 API Specification^] (covers JDBC 4.0 - 4.4, e.g. JDBC 4.4 is "`Maintenance Release 4`").
