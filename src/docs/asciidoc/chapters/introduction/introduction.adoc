...
This manual may contain documentation of features of unreleased Jaybird versions to simplify manual maintenance and versioning.
...
The <<services,Services API>> allows you to manage databases and the server itself.
It offers a Manager component to create and drop databases.
Other classes provide access to the Firebird Services Manager for database backup/restore, user management, statistics gathering, etc.
