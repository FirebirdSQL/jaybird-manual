...
dead endfootnote:[For those interested in software archaeology, you can find those
Interclient sources archived on https://github.com/FirebirdSQL/x-cvs-interclient], and the Firebird team developed a pure Java implementation of
