...
New or removed features are tagged with the version that introduced a feature (e.g. since:[Jaybird 5]) or removed feature (e.g. until:[Jaybird 5]).
...
* since:[Jaybird 5] The XCA layer represents the heart of the driver.
...
* until:[Jaybird 5] The JCA layer is an implementation of the Java/Jakarta Connector Architecture specification, and fulfils the same role as the XCA layer in Jaybird 5 and later.
