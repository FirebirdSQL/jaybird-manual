...
:icons: font
:jaybird-version: 3
:jaybird-full-version: 3.0.8
:jna-version: 4.4.0
:jaybird4-full-version: 4.0.0-beta-2
:jaybird4-template-version: 4.0.0.<java>-beta-2
:jaybird4-example-version: 4.0.0.java8-beta-2
:jaybird3-full-version: 3.0.8
